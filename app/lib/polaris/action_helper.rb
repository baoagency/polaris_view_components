module Polaris
  module ActionHelper
    def polaris_action(**args)
      Polaris::Action.new(**args)
    end

    def polaris_complex_action(**args)
    ...
    def render_complex_action_button(complex_action)
      case complex_action
        when Hash
          complex_action = polaris_complex_action(**complex_action)
      end
    ...
    def render_plain_complex_action_button(complex_aciton)
      case complex_aciton
        when Hash
          complex_aciton = polaris_complex_action(**complex_aciton)
      end
